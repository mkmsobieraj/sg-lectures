...
Entorpię zmiennej $X$ zdefiniujemy wzorem
...
Wykres entropii dla dwuch kategorii
...
- $IG(S,P)$ mieży redukcję entropii układu, spowodowaną podziałem $P$
...
będziemy rozważać tylko dżewa binarne. Przyniesie nam to następujące kożyści

- możemy posłygiwać się zyskiem informacyjnym $IG$
- łotwo dostosować algorytm do zmiennych ciągłych
...
4. Rekurencyjnie powtażaj powyższe, aż do warunku stopu
...
Popularnym sposobem radzenia sobie z przetenowaniem drzewa jest porównywanie jego 
wartości predykcyjnej na zbioże walidacyjnym lub kroswalidacyjnie (log-loss, accuracy itp.).

Stosuje się dwa podejścia

- buduje drzewo do momentu, aż wartość predykcyjna na zbiorze walidacyjnym zaczyna spadać
- buduje pełne dżewo i przycinam (prune) je do momentu, aż wartość predykcyjna na zbiorze
