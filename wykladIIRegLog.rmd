...
2. Funkcja jest nieciągła i nieróżniczkowalna co sprawia wiele problemów formalnych. Przykłądowo, gdy chemy wyznaczyć wspułćzynniki $\beta$ to co zwykle robimy to maksymalizujemy funkcję wiarygodności 
  $$
...
Jest to w 100% intujcyjne, naturalnym wydaje się, że im dalje obserwacja znajduje się od hiperpłaszczyzny tym mniejsze prawdopopdobieństwo pomyłki.
...
<!-- $$\frac{e^{\beta_0 + \beta_1 X_1 + \ldots +\beta_n X_n}}{1 + e^{\beta_0 + \beta_1 X_1 + \ldots +\beta_n X_n}}$$ 
-->
...
Flaga `delayed`  jest nadana, gdy opóźnienie wynosi więcej niż 15 minut (0 dla nie opóźnionych i 1 dla opóźnionych).
