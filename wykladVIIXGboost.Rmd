...
$$
Uwaga
Każemy jednocześnie liczbę liści jaki i wielkość współczynników.
...
Załóżmy teraz, żę struktóra drzewa jest $q(x)$ jeststała, wówczas optymalne wagi
...
## Znjadowanie najleprzego drzewa
